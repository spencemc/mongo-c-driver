...
static int
_mongoc_upload_stream_gridfs_flush (mongoc_stream_t *stream)
{
    mongoc_gridfs_upload_stream_t *gridfs = (mongoc_gridfs_upload_stream_t *) stream;
    int ret = 0;
...
static ssize_t
_mongoc_upload_stream_gridfs_readv (mongoc_stream_t *stream,
                             mongoc_iovec_t *iov,
                             size_t iovcnt,
                             size_t min_bytes,
                             int32_t timeout_msec)
{
    // this is an upload stream..... so nah
    return 0;
}
...
_mongoc_upload_stream_gridfs_writev (mongoc_stream_t *stream,
                              ...
                              int32_t timeout_msec)
{
    mongoc_gridfs_upload_stream_t *file = (mongoc_gridfs_upload_stream_t *) stream;
    ssize_t ret = 0;
    ...
    ret = mongoc_gridfs_bucket_file_writev (file->file, iov, iovcnt, 0);
...
static bool
_mongoc_upload_stream_gridfs_get_file_id(){
...
mongoc_upload_stream_gridfs_new (mongoc_gridfs_bucket_file_t *file)
{
    ...
    stream->stream.flush = _mongoc_upload_stream_gridfs_flush;
    stream->stream.writev = _mongoc_upload_stream_gridfs_writev;
    stream->stream.readv = _mongoc_upload_stream_gridfs_readv;
